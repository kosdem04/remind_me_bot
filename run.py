...
async def main():
    ...
    scheduler.add_job(check_event_start_date, trigger='cron', hour=0, minute=1, kwargs={'bot': bot})
    scheduler.add_job(check_event_start_date_in_3_days, trigger='cron', hour=0, minute=2, kwargs={'bot': bot})
    scheduler.add_job(check_event_start_date_in_7_days, trigger='cron', hour=0, minute=3, kwargs={'bot': bot})
